...
PEND_LENGTH = float(int(input("\n Enter the length of thePendulum :")))
BOB_RADIUS = float(int(input("Enter the radius of the Bob : ")))
MAX_THETA = float(int(input("Enter the maximum swingging angle :")))
THETA = 0.0
